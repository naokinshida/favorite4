...
public class FavoriteController {
 ...
 /// お気に入りの削除
    ...
    public ResponseEntity<String> deleteFavorite(@PathVariable Integer storeId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        int userId = userDetails.getMemberinfo().getId();
        ...
        favoriteService.deleteFavoriteByUserIdAndStoreId(userId, storeId);
        return ResponseEntity.ok("お気に入りから解除しました");
    }
}